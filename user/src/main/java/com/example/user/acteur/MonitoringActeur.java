 ...
 */
public class MonitoringActeur extends Acteur<Object> {

    private final SuperviseurActeur superviseur;
    private final Gson gson;
    private HttpReceiver httpReceiver;

    public MonitoringActeur(SuperviseurActeur superviseur) {
    ...
    private void handleStats(HttpExchange exchange) {
        superviseur.envoyerObjet(new SuperviseurActeur.GetStatsRequest());
    ...
    private void handleRestart(HttpExchange exchange, String query) {
        ...
        superviseur.envoyerObjet(new SuperviseurActeur.RestartActorRequest(actorName));
